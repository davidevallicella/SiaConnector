...
import static it.cs.sia.common.enums.SiaOperations.AUTORIZZAZIONE_ONLINE;
 ...
 * </table>
 */
public class SiaRichiestaAutorizzazioneOnline extends SiaBaseRequest {

    public SiaRichiestaAutorizzazioneOnline(String startKey) {
        super(AUTORIZZAZIONE_ONLINE, startKey);
    }
    ...
    public String getMac() throws SiaException {
        List<SiaParameters> params = Arrays.asList(
                ...
                CVV2, // se presente
                DATA_SCAD, IMPORTO, VALUTA, TIPO_CONTAB, CODICE_CIRCUITO,
